...
func (ec *executionContext) field_Mutation_uploadVideo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNUploadVideoInput2GalaxyᚋgraphᚋmodelᚐUploadVideoInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_uploadVideo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().UploadVideo(rctx, fc.Args["input"].(model.UploadVideoInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNVideo2ᚖGalaxyᚋgraphᚋmodelᚐVideo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_videos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Video)
	fc.Result = res
	return ec.marshalNVideo2ᚕᚖGalaxyᚋgraphᚋmodelᚐVideoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputUploadVideoInput(ctx context.Context, obj interface{}) (model.UploadVideoInput, error) {
	...
	fieldsInOrder := [...]string{"title", "description", "duration", "thumbnailUrl", "file"}
...
func (ec *executionContext) unmarshalNUploadVideoInput2GalaxyᚋgraphᚋmodelᚐUploadVideoInput(ctx context.Context, v interface{}) (model.UploadVideoInput, error) {
	res, err := ec.unmarshalInputUploadVideoInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNVideo2GalaxyᚋgraphᚋmodelᚐVideo(ctx context.Context, sel ast.SelectionSet, v model.Video) graphql.Marshaler {
	return ec._Video(ctx, sel, &v)
}

func (ec *executionContext) marshalNVideo2ᚕᚖGalaxyᚋgraphᚋmodelᚐVideoᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Video) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNVideo2ᚖGalaxyᚋgraphᚋmodelᚐVideo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNVideo2ᚖGalaxyᚋgraphᚋmodelᚐVideo(ctx context.Context, sel ast.SelectionSet, v *model.Video) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
